        ...
        <tbody>
            <?php foreach ($livres as $livre) { ?>
                ...
                <tr id="<?php print $livre['id_livre'] ?>">
                    ...
                    <td>
                        <!-- Bouton détails -->
                        <button class="btn btn-info" data-toggle="modal" data-target="#livreModal<?php echo $livre['id_livre']; ?>">Voir détails</button>
                        <!-- Bouton supprimer -->
                        <form method="POST" action="suppr.php">
                            <button id="btn_suppr" type="submit" name="btn_suppr" value="<?php echo $livre['id_livre']; ?>" class="btn btn-danger" data-toggle="modal" data-target="#confirmModal">Supprimer</button>
                        </form>
                    </td>
