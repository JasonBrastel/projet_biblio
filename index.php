                ...
                <?php foreach ($livres as $livre) { ?>
                    ...
                    <tr id="<?php print $livre['id_livre'] ?>">
                        ...
                        <form method="POST" action="suppr.php">
                            <td><button id="btn_suppr" type="submit" name="btn_suppr" value="<?php echo $livre['id_livre']; ?>" class="btn btn-danger" data-toggle="modal" data-target="#confirmModal">Supprimer</button>
                            </td>
                        </form>
                    </tr>
